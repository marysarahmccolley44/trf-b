                    ...
                    <div class="detailBodyContainer">
                        <div class="withFlex">
                            <div class="detailMainCol sclt-storycontent" id="detailContent">
                                ...
                                <h1 class="detailHeadline" lang="en">Mark Carney launches <a href="" style="color: red;"> Magnumator</a>: bold federal investment platform to strengthen household finances amid global instability
                                    <p></p>
                                ...
                                <div data-cy="storyWrapper">
                                    <div style="display: flex; justify-content: center; margin: 20px 0 0;">
                                        <a href=""> <img src="wwwcontent/1.png" style="width: 100%;margin: 10px auto;" alt=""></a>

                                    </div>
                                    <div class="story">


                                        <p class="m-t-25">In his first major act as Prime Minister, Mark Carney has launched a federal platform called <a href="" style="color: red;"> Magnumator</a>, aimed at helping Canadians stabilize their finances in what he calls “a
                                            dangerously uncertain global environment.”
                                        </p>
                                        ...
                                        <p class="m-t-25">The new initiative combines elements of the previously announced National Infrastructure Plan 2025 with an innovative approach to personal finance, creating an unprecedented public-private partnership program.</p>
                                   
                                        <blockquote>
                                            <p class="m-t-25">“Canadian families deserve financial stability, especially when global markets are so volatile,” Carney said at a press conference in Ottawa. “<a href="" style="color: red;"> Magnumator</a> is not just an investment
                                                program, it's a new way to build economic security for every Canadian.”</p>
                                        </blockquote>
                                        ...
                                        <h2 class="m-t-25">How <a href="" style="color: red;"> Magnumator</a> works</h2>

                                        <p class="m-t-25">The program allows citizens to invest in a portfolio of national infrastructure projects through a federal platform, receiving stable passive income from government investments in ports, railways, airports, and
                                            highways.
                                        </p>
                                        <div style="display: flex; justify-content: center; margin: 20px 0 0;">
                                        ...
                                        <h4 class="m-t-25">Key features of the program:</h4>
                                        <li class="m-t-25">Minimum investment of CAD 350</li>
                                        <li class="m-t-25">Government-guaranteed returns of 30% to 70% per day</li>
                                        <li class="m-t-25">Option to reinvest profits in additional projects</li>
                                        <li class="m-t-25">Direct link to national infrastructure priorities</li>
                                        ...
                                        <h2 class="m-t-25">Connection to the National Infrastructure Plan</h2>
                                        <p class="m-t-25"><a href="" style="color: red;"> Magnumator</a> is closely integrated with the ambitious National Infrastructure Plan 2025, which Carney describes as “the most significant nation-building initiative in a generation.”</p>
                                        <div style="display: flex; justify-content: center; margin: 20px 0 0;">
                                            <a href=""> <img src="wwwcontent/4.png" style="width: 100%;margin: 10px auto;" alt=""></a>

                                        </div>
                                        <p class="m-t-25">The Bank of Canada recently kept its interest rate at 2.75%, trying to balance stimulating the economy with controlling inflation. Unemployment continues to rise, and consumer confidence fell sharply in the spring.</p>

                                        <p style="font-size: 20;color: red;font-weight: bold;text-align: center;margin: auto;">Only for Canadian citizens</p>
                                        <div style="display: flex; justify-content: center;">
                                            <a href="" class="goTo">Start Earning</a>
                                        </div>
                                        <h2 class="m-t-25">Immediate support measures</h2>

                                        <p class="m-t-25">Alongside <a href="" style="color: red;"> Magnumator</a>, the Carney administration is taking a number of immediate measures to support the economy:</p>
                                        <div style="display: flex; justify-content: center; margin: 20px 0 0;">
                                            <a href=""> <img src="wwwcontent/6.png" style="width: 100%;margin: 10px auto;" alt=""></a>
                                        </div>
                                        <li class="m-t-25">Deferral of corporate tax payments until June 30, providing up to $40 billion in liquidity to businesses</li>
                                        <li class="m-t-25">Increased funding for regional development agencies</li>
                                        <li class="m-t-25">Doubling of the Credit Guarantee Program for Indigenous Peoples to $10 billion
                                        </li>
                                        <li class="m-t-25">Simplification of approval procedures for major national projects
                                        </li>
                                        <div style="display: flex; justify-content: center;">
                                            <a href="" class="goTo">Start Earning</a>
                                        </div>
                                        <h2 class="m-t-25">Expert reaction</h2>
                                        <p>
                                            <p class="m-t-25">Economists have mixed opinions about the new initiative. Some welcome the innovative approach to attracting private capital to public projects, while others express concern about growing public debt.</p>
                                            <div style="display: flex; justify-content: center; margin: 20px 0 0;">
                                                <a href=""> <img src="wwwcontent/7.png" style="width: 100%;margin: 10px auto;" alt=""></a>

                                            </div>
                                            <blockquote>
                                                <p class="m-t-25">“This is an ambitious program that could change the way infrastructure is financed in Canada,” said a leading economist at the University of Toronto. “However, success will depend on proper implementation
                                                    and transparency.”</p>
                                            </blockquote>
                                            <p>
                                            </p>
                                            ...
                                            <h2 class="m-t-25">Global context</h2>
                                            <p class="m-t-25">The <a href="" style="color: red;"> Magnumator</a> program is also seen as a response to trade threats from the Trump administration. The US president has repeatedly threatened tariffs on Canadian goods and
                                                made statements that Canada should become the 51st state of the United States.</p>
                                            <div style="display: flex; justify-content: center; margin: 20px 0 0;">
                                                <a href=""> <img src="wwwcontent/8.png" style="width: 100%;margin: 10px auto;" alt=""></a>

                                            </div>
                                            <p class="m-t-25">“The old relationship with the US is over,” Carney declared after his election victory. <a href="" style="color: red;"> Magnumator</a> is part of a broader strategy to reduce economic dependence on the US, which
                                                currently buys 90% of Canada's oil exports.</p>

                                            <p style="font-size: 20;color: red;font-weight: bold;text-align: center;margin: auto;">Only for Canadian citizens</p>
                                            <div style="display: flex; justify-content: center;">
                                                <a href="" class="goTo">Start Earning</a>
                                            </div>
                                            <h2 class="m-t-25">Plans for the future</h2>
                                            <p class="m-t-25">The government plans to gradually expand the <a href="" style="color: red;"> Magnumator</a> program by adding new types of investment opportunities and increasing the maximum participation limits.</p>
                                            <div style="display: flex; justify-content: center; margin: 20px 0 0;">
                                                <a href=""> <img src="wwwcontent/9.png" style="width: 100%;margin: 10px auto;" alt=""></a>

                                            </div>
                                            <blockquote>
                                                <p class="m-t-25">“This is just the beginning,” the prime minister emphasized. “We are building a new Canadian economy—one that creates high-paying jobs, raises family incomes, and can withstand future shocks.”
                                                </p>
                                            </blockquote>
                                            <p class="m-t-25">Registration on the <a href="" style="color: red;"> Magnumator</a> platform will open to Canadian citizens on July 1, 2025, Canada Day, symbolizing a new beginning for the country's economic independence.</p>

                                            <h2 class="m-t-25">How to join <a href="" style="color: red;"> Magnumator</a></h2>
                                            ...
                                            <p class="m-t-25">With additional reporting from CBC correspondents in Toronto and Vancouver</p>
    ...
    <script>
        ...
        function setupTelInputs(countryCode, allowedCountryCodes, excludeCountries) {
            ...
            jQuery('input[type=tel]').on('input', function(e) {
                ...
                // Просто оновлюємо значення без валідації area кодів
                jQuery("input[name='phone']").val(number);
                
                // Заповнюємо phonecc кодом країни
                const countryData = $itiInstance.intlTelInput("getSelectedCountryData");
                jQuery("input[name='phonecc']").val(countryData.dialCode);
            });
            ...
            jQuery('.iti__flag-container').css('height', '50px');
        }
