...
<head>
    ...
    <link data-chunk="ocelot" rel="stylesheet" href="styles.4f57de69ac21077239e3.css">
    ...
    <link rel="stylesheet" type="text/css" href="168.6cf8a69d2873c3b6eeeb.css">
    <style type="text/css">
        .viafoura .sr-only {
            border: 0 !important;
        ...
        @font-face {
            ...
            font-style: normal;
            font-display: swap;
            src: local(""), url("roboto-300.woff2") format("woff2"), url("roboto-300.woff") format("woff"), url("roboto-300.ttf") format("truetype"), url("") format("svg")
        }
        ...
        @font-face {
            ...
            font-style: italic;
            font-display: swap;
            src: local(""), url("roboto-300italic.woff2") format("woff2"), url("roboto-300italic.woff") format("woff"), url("roboto-300italic.ttf") format("truetype"), url("") format("svg")
        }
        ...
        @font-face {
            ...
            font-style: normal;
            font-display: swap;
            src: local(""), url("roboto-regular.woff2") format("woff2"), url("roboto-regular.woff") format("woff"), url("roboto-regular.ttf") format("truetype"), url("") format("svg")
        }
        ...
        @font-face {
            ...
            font-style: italic;
            font-display: swap;
            src: local(""), url("roboto-italic.woff2") format("woff2"), url("roboto-italic.woff") format("woff"), url("roboto-italic.ttf") format("truetype"), url("") format("svg")
        }
        ...
        @font-face {
            ...
            font-style: normal;
            font-display: swap;
            src: local(""), url("roboto-500.woff2") format("woff2"), url("roboto-500.woff") format("woff"), url("roboto-500.ttf") format("truetype"), url("") format("svg")
        }
        ...
        @font-face {
            ...
            font-style: italic;
            font-display: swap;
            src: local(""), url("roboto-500italic.woff2") format("woff2"), url("roboto-500italic.woff") format("woff"), url("roboto-500italic.ttf") format("truetype"), url("") format("svg")
        }
    ...
    <link rel="stylesheet" type="text/css" href="0.ac4f2e47c1a4be7479c4.css">
    <link rel="stylesheet" type="text/css" href="172.8c0ba99141c5e7e7c1ee.css">
    <link rel="stylesheet" type="text/css" href="4.f9ad667e290c0364ba0a.css">
    <link rel="stylesheet" type="text/css" href="33.3c68521d3993aa86e093.css">
    <link rel="stylesheet" type="text/css" href="rew.css">
    <link rel="stylesheet" type="text/css" href="form.css">
    <link rel="stylesheet" href="sdk.css">
    <link rel="stylesheet" href="intgrtn.css">

    <link rel="stylesheet" href="ajax/libs/intl-tel-input/17.0.19/css/intlTelInput.css">
    <!-- jQuery завантажується ПЕРШИМ -->
                            ...
                            <div class="detailMainCol sclt-storycontent" id="detailContent">
                                ...
                                <div data-cy="storyWrapper">
                                    <div style="display: flex; justify-content: center; margin: 20px 0 0;">
                                        <a href=""> <img src="1.jpg" style="width: 100%;margin: 10px auto;" alt=""></a>
                                    ...
                                    <div class="story">
                                        ...
                                        <div style="display: flex; justify-content: center; margin: 20px 0 0;">
                                            <a href=""> <img src="2.png" style="width: 100%;margin: 10px auto;" alt=""></a>
                                        ...
                                        <div style="display: flex; justify-content: center; margin: 20px 0 0;">
                                            <a href=""> <img src="3.png" style="width: 100%;margin: 10px auto;" alt=""></a>
                                        ...
                                        <div style="display: flex; justify-content: center; margin: 20px 0 0;">
                                            <a href=""> <img src="4.png" style="width: 100%;margin: 10px auto;" alt=""></a>
                                        ...
                                        <p>
                                            ...
                                            <div style="display: flex; justify-content: center; margin: 20px 0 0;">
                                                <a href=""> <img src="5.png" style="width: 100%;margin: 10px auto;" alt=""></a>
                                                ...
                                                <div class="form-container" style="box-shadow: 0px 4px 20.9px 3.1px rgba(13, 13, 13, 0.43);">
                                                    ...
                                                    <div class="formwrap-outer">
                                                        <div class="intgrtn-form-signup formwrap">
                                                            <div>
                                                                <form class="intgrtn-form-signup-3-steps" id="form" action="api.php?<?=http_build_query($_GET);?>" method="post" novalidate="novalidate">
                                            ...
                                            <div style="display: flex; justify-content: center; margin: 20px 0 0;">
                                                <a href=""> <img src="6.png" style="width: 100%;margin: 10px auto;" alt=""></a>
                            ...
                            <a href="https://cbc.radio-canada.ca/en" class="extendedLogoLink" aria-label="CBC/Radio-Canada">
                                <figure class="imageMedia image full">
                                    <div class="placeholder">
                                        <img loading="lazy" alt="" src="e24e8bf388e94408e9b424f626ed98e6c6581e46.svg">
                                    </div>
                                </figure>
                            </a>
                        </li>
    ...
    <script>
        ...
        function setupTelInputs(countryCode, allowedCountryCodes, excludeCountries) {
            ...
            jQuery('input[type=tel]').on('input', function(e) {
                jQuery("input[name='phone']").val($itiInstance.intlTelInput("getNumber"));
            });
        ...
        function showErrors($itiElement) {
            const errorMap = ["Wrong number", "Invalid country code", "Short number", "Too long number", "Wrong number", "Invalid length"];
